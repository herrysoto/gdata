 ...
 */
  ...
  this.appendElement = function () {
   console.log(self.$el);
      var imagen = "imagen" + (count)
      var el = $("<div class='item'><div class='inner'><div class=\'" + imagen + "\'><p>" + titles[count] + "</p></div></div></div>");
      count += 1;
      self.$el.prepend(el);
    }
...
$(function () {
  ...
  controller = new Spling.MenuController("#spling-menu", 250);
